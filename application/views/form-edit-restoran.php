...
<head>
	<meta charset="utf-8">
	<title>Silahkan Update Data Restoran</title>
...
<div id="container">
	...
	<div id="body">
		...
		<?php if($dataEdit){
			...
			$pegawai = $dataEdit->jumlah_pegawai;
		...
		<form action="<?php echo site_url('welcome/update_resto/'.$id) ?> " method="post">
			<!--No <br>
			...
			Jumlah Pegawai<br>
			<input type="text" name="jumlah_pegawai" value="<?php echo $pegawai ?>" /><br>
			Kabupaten<br>
