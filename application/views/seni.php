...
<div id="container">
	...
	<div id="body">
		...
		<a href="<?php echo site_url('welcome/form_input_seni')?>">Tambah Data Seni</a>
		<table border="1">
		...
		<table border="1">
			...
			<tr>
				...
				<td><?php echo $r['pekerja'] ?></td>
				<td><?php echo $r['jenis'] ?></td>
				<td><?php echo $r['Action']?>

					<a href="<?php echo site_url('welcome/form_edit_seni/'.$r['id'])?>">Edit</a>
					||
					<a href="<?php echo site_url('welcome/deleteSeni/'.$r['id'])?>"onclick = "return confirm('Yakin ingin hapus data? ')">Hapus</a>
