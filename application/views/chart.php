...
<html>
  ...
  var data = google.visualization.arrayToDataTable([
        ...
        var piechart_options = {title:'Jenis dan Jumlah Hotel Berbintang di Sumatera Selatan tahun 2017',
                       width:400,
                       height:300};
        var piechart = new google.visualization.PieChart(document.getElementById('piechart_div'));
        piechart.draw(data, piechart_options);

        var barchart_options = {title:'Jenis dan Jumlah Hotel Berbintang di Sumatera Selatan tahun 2017',
                       width:400,
                       height:300,
                       legend: 'none'};
